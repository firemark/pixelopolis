...
#define HELPER_ALLOCATE_ARRAY(helper, type, c) \
    MEMORY_ALLOCATE_ARRAY(helper->program->product_memory, type, c)
...
// inlines
static inline double builder_make_theta(const int rotate) { return rotate * M_PI / 180.0; }
