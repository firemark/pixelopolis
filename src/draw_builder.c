...
#define IF_NAME(str) else if (!strcmp(element, str))
    if (!element) obj = NULL; 
    IF_NAME("void") obj = _build_void(&inner_helper);
    IF_NAME("cube") obj = _build_cube(&inner_helper);
    IF_NAME("triangle") obj = _build_triangle(&inner_helper);
    IF_NAME("pyramid") obj = _build_pyramid(&inner_helper);
    IF_NAME("v-series") obj = _build_series(&inner_helper, VERTICAL_FILL);
    IF_NAME("d-series") obj = _build_series(&inner_helper, DEPTH_FILL);
    IF_NAME("h-series") obj = _build_series(&inner_helper, HORIZONTAL_FILL);
    IF_NAME("v-filler") obj = _build_filler(&inner_helper, VERTICAL_FILL);
    IF_NAME("d-filler") obj = _build_filler(&inner_helper, DEPTH_FILL);
    IF_NAME("h-filler") obj = _build_filler(&inner_helper, HORIZONTAL_FILL);
    else obj = NULL;
#undef IF_NAME
