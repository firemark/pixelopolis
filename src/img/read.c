...
static int _read_png_init(const char* file_name, FILE** fp, png_structp* png_ptr_ptr, png_infop* info_ptr_ptr, struct PngReadMeta* meta) {
    ...
    *info_ptr_ptr = info_ptr;
    ...
    switch (color_type) {
        case PNG_COLOR_TYPE_RGB: meta->pixel_size = 3; break;
        case PNG_COLOR_TYPE_RGBA: meta->pixel_size = 4; break;
        default:
